...
--
-- Estructura de tabla para la tabla `bodas_cronicas`
--

DROP TABLE IF EXISTS `bodas_cronicas`;
...
--
-- Estructura de tabla para la tabla `bodas_dedicatorias`
--

DROP TABLE IF EXISTS `bodas_dedicatorias`;
