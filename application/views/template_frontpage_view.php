    ...
    <div class="container">
        ...
        <div class="clear span-24 last main-container"> 
            ...
            <div class="i">
                ...
                <div class="fright"><a href="<?=site_url('/paneluser/index/logout/')?>" class="link-img"><img src="images/icon_logout.png" alt="" width="16" height="16" />&nbsp;Cerrar Sesi&oacute;n</a></div>
                <?php }?>
