    ...
    <form id="form1" action="<?//=site_url('/paneluser/')?>" method="post" enctype="application/x-www-form-urlencoded">
        <div class="trow">
            <label class="label label-contact" for="txtDedicatoria">
                Cr&oacute;nica<br/>
            </label>
            <label class="label label-contact" for="txtDedicatoria"></label>
            <div class="fleft"><textarea id="txtConsult" name="txtConsult" rows="5" cols="22" class="textarea-contact2"></textarea></div>
        </div>
