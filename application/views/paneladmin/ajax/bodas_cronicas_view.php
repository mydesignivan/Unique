...
<?php if( count($list)>0 ){?>
<h1 class="align-center" >Cr&oacute;nicas</h1>
    
    <div class="trow">
        <div class="fright">
            <button type="button" onclick="BodasList.comments_del_sel('<?=TBL_CRONICA?>');">Eliminar Seleccionados</button>
        </div>
    </div>
    ...
    ?>
            <tr class="<?=$class?>">
                ...
                <td class="cell4"><a href="javascript:void(BodasList.comments_del(<?=$row['id']?>,'<?=TBL_CRONICA?>'))" class="link1"><img src="images/icon_delete.png" alt="" width="16" alt="16" /><span>Eliminar</span></a></td>
            </tr>
    <?php }?>
        </tbody>
    </table>
