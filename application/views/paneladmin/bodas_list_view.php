...
<div class="trow">
    <button type="button" onclick="location.href='<?=site_url('paneladmin/bodas/form')?>'" class="fright">Eliminar Seleccionados</button>
...
?>
        <tr id="tr<?=$row['bodas_id']?>" class="<?=$class?>">
            ...
            <td class="cell4"><a href="<?=$url?>"><img src="images/icon_edit.png" alt="" width="16" alt="16" /><span>Modificar</span></a></td>
            <td class="cell5"><a href="javascript:Products.del(<?=$row['bodas_id']?>)"><img src="images/icon_delete.png" alt="" width="16" alt="16" /><span>Eliminar</span></a></td>
        </tr>
<?php }?>
    </tbody>
</table>
